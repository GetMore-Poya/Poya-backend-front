                ...
                <div class="fixed insert-0 z-10 overflow-y-auto mt-6">
                    <div class="flex min-h-full items-end justify-center p-4 items-center py-2">
                        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all my-8 mt-10 max-w-4xl">
                            <div class="w-full bg-white px-4 pt-5 pb-4 p-6">
                                    ...
                                    <div class="mt-3 text-left">
                                           ...
                                           <div class="flex justify-center max-w-2xl">
                                                <Cropper
                                                    ...
                                                    :stencil-props="{
                                                     //    aspectRatio : 8/8,
                                                         minAspectRatio: minAspectRatiow/minAspectRatiow,
                                                         maxAspectRatio: maxAspectRatioh/maxAspectRatioh
                                                    }"
                                                    @change="change"
                                                ></cropper>
                                           </div>
...
<script setup>
  //  import { ref, defineEmits } from 'vue';
    ...
    console.log(minAspectRatioProp.width,maxAspectRatioProp.width);
        // minAspectRatioProp.width={width:8};
        // minAspectRatioProp.height={height:8};

      let minAspectRatiow = 8;

      let  maxAspectRatioh=8
    ...
    const crop=() => {
        const { coordinate, canvas } = cropper.value.getResult()
        croppedImageData.file = fileInput.value.files[0]
        croppedImageData.imageUrl = canvas.toDataURL()
        croppedImageData.height = coordinate.height
        croppedImageData.width = coordinate.width
        croppedImageData.left = coordinate.left
        croppedImageData.top = coordinate.top
