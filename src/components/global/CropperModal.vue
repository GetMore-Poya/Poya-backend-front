...
<script setup>
    ...
    if(minAspectRatioProp.width=='NaN' || minAspectRatioProp.width =='undefined')
    {
        minAspectRatioProp.width=8;
    }
    if(minAspectRatioProp.height=='NaN'  || minAspectRatioProp.height =='undefined')
    {
        minAspectRatioProp.height=8;
    }
    if(maxAspectRatioProp.width=='NaN' || maxAspectRatioProp.width =='undefined')
    {
        maxAspectRatioProp.width=8;
    }
    if(maxAspectRatioProp.height=='NaN'  || maxAspectRatioProp.height =='undefined')
    {
        maxAspectRatioProp.height=8;
    }
    // let maspw= isEmptyObject(
    console.log(minAspectRatioProp,maxAspectRatioProp)
